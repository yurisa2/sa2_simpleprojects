...
class tDAL
{
	...
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__tasks;
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__tasks_stakeholders;
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__uggroups;
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__ugmembers;
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__ugrights;
	var $tblsa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "tasks", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__tasks", "altvarname" => "tasks", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "tasks_stakeholders", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__tasks_stakeholders", "altvarname" => "tasks_stakeholders", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "uggroups", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__uggroups", "altvarname" => "uggroups", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "ugmembers", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__ugmembers", "altvarname" => "ugmembers", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "ugrights", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__ugrights", "altvarname" => "ugrights", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
		$this->lstTables[] = array("name" => "users", "varname" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br__users", "altvarname" => "users", "connId" => "sa2_simple_erv_at_sa2_simple_erv_mysql_dbaas_com_br", "schema" => "", "connName" => "sa2_simple_erv at sa2_simple_erv.mysql.dbaas.com.br");
	}
