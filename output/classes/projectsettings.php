...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "projects" ] = array( "url" => "projects", "type" => 0 );
	$projectEntitiesReverse[ "projects" ] = "projects";
	$projectEntities[ "stakerholders" ] = array( "url" => "stakerholders", "type" => 0 );
	$projectEntitiesReverse[ "stakerholders" ] = "stakerholders";
	$projectEntities[ "projects_stakeholders" ] = array( "url" => "projects_stakeholders", "type" => 0 );
	$projectEntitiesReverse[ "projects_stakeholders" ] = "projects_stakeholders";
	$projectEntities[ "tasks" ] = array( "url" => "tasks", "type" => 0 );
	$projectEntitiesReverse[ "tasks" ] = "tasks";
	$projectEntities[ "tasks_stakeholders" ] = array( "url" => "tasks_stakeholders", "type" => 0 );
	$projectEntitiesReverse[ "tasks_stakeholders" ] = "tasks_stakeholders";
