...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("projects" == $this->chrt_array['tables'][0])
			return true;
		if("stakerholders" == $this->chrt_array['tables'][0])
			return true;
		if("projects_stakeholders" == $this->chrt_array['tables'][0])
			return true;
		if("tasks" == $this->chrt_array['tables'][0])
			return true;
		if("tasks_stakeholders" == $this->chrt_array['tables'][0])
			return true;
		if("events" == $this->chrt_array['tables'][0])
			return true;
		if("ugrights" == $this->chrt_array['tables'][0])
			return true;
