...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("projects" == $this->xml_array['tables'][0])
			$isDB = true;
		if("stakerholders" == $this->xml_array['tables'][0])
			$isDB = true;
		if("projects_stakeholders" == $this->xml_array['tables'][0])
			$isDB = true;
		if("tasks" == $this->xml_array['tables'][0])
			$isDB = true;
		if("tasks_stakeholders" == $this->xml_array['tables'][0])
			$isDB = true;
		if("events" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
